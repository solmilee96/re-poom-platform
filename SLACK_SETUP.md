...
4. **API 직접 호출 테스트**  
   ...
   `curl -X POST https://web-mdrkzqom5-solmilee96s-projects.vercel.app/api/feedback -H "Content-Type: application/json" -d '{"choice":"아쉬워요","text":"테스트","childName":""}'`  
...
- Vercel 프로젝트 URL이 `web-mdrkzqom5-solmilee96s-projects.vercel.app` 이 아닌 경우, `docs/index.html` 의 `FEEDBACK_API_URL` 을 실제 Vercel 배포 URL로 바꾼 뒤 다시 배포해야 합니다.
